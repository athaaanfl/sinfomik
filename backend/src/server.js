...
const corsOptions = {
    origin: process.env.NODE_ENV === 'production' 
        ? [FRONTEND_URL, 'https://*.azurewebsites.net', 'https://*.azurestaticapps.net', 'https://sinfomik-backend-gzcng8eucydhgucz.southeastasia-01.azurewebsites.net', 'https://salmon-glacier-082ece600.3.azurestaticapps.net','https://sinfokas.online', 'https://www.sinfokas.online', 'http://34.123.111.227'] // Allow Azure domains
